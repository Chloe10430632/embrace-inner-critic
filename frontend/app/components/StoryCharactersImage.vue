...
.scene-talk .protagonist-layer { animation:pressure-in .55s ease-out both,tense-breathe 1.6s .55s ease-in-out infinite; transform-origin:34% 65%; }
.scene-talk .critic-layer { animation:critic-talk .48s ease-in-out infinite alternate; transform-origin:76% 55%; }
.scene-separate .protagonist-layer { animation:person-release 1.2s ease-out both,soft-breathe 3.6s 1.2s ease-in-out infinite; }
.scene-separate .critic-layer { animation:critic-step-back 1.25s ease-out both,critic-hover 2.2s 1.25s ease-in-out infinite; }
